...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//Função para gerar as relações automáticas por motivo de teste
//recebe por parametro o url do arquivo que será criado e a quantidade de nós
//
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void cria_relacao(int quantidade,char nome[99]){
	//cria uma semente para gerar um número pseudo aleatorio
	srand(time(NULL));
	//cria um ponteiro de arquivo para criar esse arquivo
	FILE *arquivo;
	//abre o arquivo
	arquivo = fopen(nome,"w");
	//printa a quantidade de nós
	fprintf(arquivo,"n %i\n",quantidade);
	int relacao1;
	int relacao2;
	//dois fors para gerar as relacoes tando de ida como de volta caso tenha
	for(int i = 0; i < quantidade; i++){
		for(int j = 0; j < quantidade; j++){
			//gera números aleatorios de 0 a 1, se for 1 nos dois haverá relacao entre eles
			relacao1 = rand() % 2;
			relacao2 = rand() % 2;
			if(relacao1 == 1 && relacao2 == 1){
				fprintf(arquivo,"r %i %i\n",i + 1,j + 1);
			}
		}
	}
	//printa o f no final do arquivo para indicar o final
	fprintf(arquivo,"f");
	//fecha o ponteiro
	fclose(arquivo);
}
